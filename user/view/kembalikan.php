...
<body id="page-top">
    ...
    $sql2 = mysqli_query($koneksi, "SELECT a.*, b.*,c.no_ruangan ,c.nama_ruangan FROM peminjaman a JOIN pengembalian b ON a.id_peminjaman = b.id_peminjaman JOIN ruangan c ON a.id_ruangan = c.id_ruangan WHERE b.id = '$id' AND a.id_peminjam = '$peminjam'");
            ...
            <div id="content">
                ...
                <div class="container-fluid"
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-white">Pengembalian Ruangan </h1>
                    </div>
                    <div class="row" style="text-align:left;">
                        <div class="col-lg-6">
                            <form style="color: white;" action="../f_aksi/kembali.php" method="post"
                                enctype="multipart/form-data">
                                <input type="hidden" name="id2" id="id2" value="<?= $data2['id']?>">
                                <div class="form-group">
                                    <label for="nama_kegiatan">Nama Kegiatan</label>
                                    <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan"
                                        value="<?=$data2['nama_kegiatan']?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_kegiatan">Nama Ruangan</label>
                                    <input type="text" class="form-control" id="nama_ruangan" name="nama_ruangan"
                                        value="<?php echo $data2['no_ruangan']; ?> <?= '-' ?> <?php echo $data2['nama_ruangan'];?>"
                                        readonly>
                                </div>
                                <div class="form-group">
                                    <label for="tgl_acara">Tgl Kegiatan</label>
                                    <input type="text" class="form-control" id="tgl_acara" name="tgl_acara"
                                        value="<?php echo $data2['tgl_acara']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="tgl_akhir_acara">Tgl Pengembalian</label>
                                    <input type="text" class="form-control form_datetime" id="tgl_pengembalian"
                                        name="tgl_pengembalian" readonly required>
                                </div>
                                <div class="form-group">
                                    <label for="PJ">Foto Ruangan</label><br>
                                    <input type="file" id="foto_b" name="foto_b" required>
                                </div>
                                <div class="form-group">
                                    <label for="kendala">Umpan Balik</label>
                                    <textarea class="form-control" id="kendala" name="kendala" rows="3"
                                        placeholder="Umpan Balik" required></textarea>
                                </div>
                        </div>
