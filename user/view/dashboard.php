            ...
            <div id="content">
                ...
                <div class="container-fluid"
                    ...
                    <div class="row mx-auto">
                        <?php
                                include '../../admin/koneksi.php';
                                $sql7 = mysqli_query($koneksi, "SELECT * FROM ruangan WHERE status = '1' ORDER BY id_ruangan ASC");

                                while ($data7 = mysqli_fetch_array($sql7)) {
                                    ?>

                        <div class="card ml-2 mr-2">
                            <a href="detail_ruangan.php?id2=<?=$data7['id_ruangan']?>">
                                <img src="../../admin/view/asset/img/<?= $data7['foto']; ?>" class="card-img-top"
                                    id="img_r" height="150px" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title"><?= $data7['no_ruangan']; ?>
                                    </h5>
                                    <p class="card-text"><?= $data7['nama_ruangan']; ?></p>
                                </div>
                            </a>
                        </div>
                        <?php } ?>
