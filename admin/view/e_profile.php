...
<head>
    ...
    <title>Admin PR-MB | Edit Profile</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid"
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <form action="../f_update/update_profile.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12 ">
                                        <div class="row text-dark">
                                            <div class="col-sm-11 bg-white p-3 ml-3 rounded ">
                                                <div class="img">
                                                    <img class="img-profile rounded-circle" width="50%"
                                                        src="asset/img/profile/<?php echo $data['foto_u']; ?>"></div>
                                            ...
                                            <a href="profile.php" class="btn text-black-50"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2"></i>Kembali</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 bg-white p-3 ml-3 mr-3 rounded" align="left">
                            ...
                            <div class="form-group">
                                ...
                                <a href="#" class="btn form-control" id="up" data-target="#ModalEditPass<?php echo $data['id_peminjam']; ?>" 
                    ...
                    <div class="modal fade" id="ModalEditPass<?php echo $data['id_peminjam']; ?>" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" align="left">
                                    <form action="../f_update/edit_pass.php" method="post">
                                        <div class="form-row">
