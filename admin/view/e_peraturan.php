...
<head>
    ...
    <title>Admin PR-MB | Data Peraturan</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            ?>
                            <form action="../f_update/update_peraturan.php" method="post">
                                <div class="col-lg-12">
                                    <div class="row text-dark">
                                        <div class="col-sm-11 bg-white p-3 rounded ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="isi_peraturan" class="ckeditor form-control"
                                                    id="isi_peraturan"><?= $data5['isi_peraturan']?></textarea>
                                            </div>
