...
<head>
    ...
    <title>Admin PR-MB | Data Fasilitas</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="text-white">Data Fasilitas</h1>
                    <!-- DataTales Example -->
                                ...
                                <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">DETAIL FASILITAS</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr align="left">
                                            ...
                                            <td><?php echo $data['detail_fasilitas']; ?></td>
                                            <td>
                                                <a href="#" data-target="#EditFas<?php echo $data['id_fasilitas']; ?>"
                                                    data-toggle="modal"><i
                                                        class="fas fa-edit bg-success p-2 text-white rounded"></i></a>
                                                <a href="#" data-target="#DeleteFas<?php echo $data['id_fasilitas']; ?>"
                                                    data-toggle="modal"><i
                                                        class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i></a>
                                            </td>
                                            <!-- Modal Delete -->
                    <div class="modal fade" id="DeleteFas<?php echo $data['id_fasilitas']; ?>" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="label">Hapus Data Fasilitas
                                    </h5>
                    ...
                    <!-- /ModalDelete -->
                                        ...
                                        <!-- Modal Edit -->
                                        <div class="modal fade" id="EditFas<?php echo $data['id_fasilitas']; ?>" tabindex="-1" role="dialog"
                                            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" name="nama_fasilitas" class="form-control"
                                                                        id="nama_fasilitas" value="<?= $data['nama_fasilitas'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" name="detail_fasilitas" class="form-control"
                                                                        id="detail_fasilitas" value="<?= $data['detail_fasilitas'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="submit"
                        ...
                        <div class="modal-body">
                            <form action="../f_tambah/simpan_fs.php" method="post">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>Detail Fasilitas</label>
                                        <input type="text" name="detail_fasilitas" class="form-control" id="detail_fasilitas">
                                    </div>
                                </div>
                                <div class="modal-footer">
