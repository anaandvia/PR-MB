...
<head>
    ...
    <title>Admin PR-MB | Data Ruangan</title>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <form class="form-inline my-2 my-lg-0 ml-auto">
                                ...
                                <a href="../f_pdf/domruangan.php" class="btn btn-warning mb-2 btndata">
                                ...
                                <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><a
                                                    href="f_ruangan.php?id=<?=$data['id_ruangan']?>"><?php echo $data['no_ruangan']; ?></a>
                                            </td>
                                            <td><a
                                                    href="detail_r.php?id2=<?=$data['id_ruangan']?>"><?php echo $data['nama_ruangan']; ?></a>
                                            </td>
                                            <td><?php echo $data['lantai']; ?></td>
                                            <td><?php echo $data['kapasitas']; ?></td>
                                            <td><?php echo '<a href="#" data-target="#LihatFoto2'.$data['id_ruangan'].'"
                                                    data-toggle="modal"><img src ="asset/img/'.$data["foto2"].'" width = "100" height = "100"></a>';?>
                                            </td>
                                            <td><?php echo '<a href="#" data-target="#LihatFoto'.$data['id_ruangan'].'"
                                                    data-toggle="modal"><img src ="asset/img/'.$data["foto"].'" width = "100" height = "100"></a>';?>
                                            </td>
                                            <!-- Modal Lihat -->
                                            <div class="modal fade" id="LihatFoto<?php echo $data['id_ruangan']; ?>"
                                            ...
                                            ?></td>
                                            <td>
                                                <a href="#" data-target="#EditRoom<?php echo $data['id_ruangan']; ?>"
                                                    data-toggle="modal"><i
                                                        class="fas fa-edit bg-success p-2 text-white rounded"></i></a>
                                                <a href="#" data-target="#DeleteRoom<?php echo $data['id_ruangan']; ?>"
                                                    data-toggle="modal"><i
                                                        class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i></a>
                                            </td>
                                            <!-- Modal Lihat -->
                                            <div class="modal fade" id="LihatFoto2<?php echo $data['id_ruangan']; ?>"
                                                tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-lg"
                                                    role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <img src="asset/img/<?=$data['foto2']?>" alt=""
                                                                width="100%">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!-- /ModalLihat -->
                                            <!-- Modal Delete -->
                                            <div class="modal fade" id="DeleteRoom<?php echo $data['id_ruangan']; ?>"
                                                tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                                                aria-hidden="true">
                                        ...
                                        <!-- Modal Edit -->
                                        <div class="modal fade" id="EditRoom<?php echo $data['id_ruangan']; ?>"
                                            tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../f_update/update_ruangan.php" method="post"
                                                            ...
                                                            <input type="hidden" name="fotolama" id="fotolama"
                                                                value="<?= $data['foto']?>">
                                                            <input type="hidden" name="fotolama2" id="fotolama2"
                                                                value="<?= $data['foto2']?>">
                                                            <div class="form-row">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <select class="form-control" id="lantai"
                                                                        name="lantai" value="<?=$data["no_lantai"]?>">
                                                                        <?php
                                                                        $sql2 = mysqli_query($koneksi, "SELECT * FROM lantai ORDER BY no_lantai ASC");
                                                                        while($row=mysqli_fetch_array($sql2)){
                                                                            if ($row['no_lantai'] == $data['lantai']){
                                                                                $select = "selected";
                                                                            }else{
                                                                                $select = "";
                                                                            }
                                                                            echo "<option $select value='$row[no_lantai]'>$row[no_lantai]</option>\n";
                                                                        }
                                                                        ?>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" name="kapasitas"
                                                                        class="form-control" id="kapasitas"
