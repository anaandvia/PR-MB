...
<head>
    ...
    <title>Admin PR-MB | Data Admin</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a href="#" id="tambahusr" class="btn btn-warning mb-2 btndata">
                                    <i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA ADMIN</a>&nbsp;
                                <a href="../f_pdf/domadmin.php" class="btn btn-warning mb-2 btndata">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="dataTable" width="100%"
                                    ...
                                    <tbody>
                                        <?php
                                        include '../koneksi.php';
                                        $sql = mysqli_query($koneksi, "SELECT a.* , b.* FROM jurusan b JOIN peminjam a ON b.id_jurusan=a.id_jurusan WHERE level='admin'");
                                        $no = 1;
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="../f_hapus/delete_adm.php" method="post">
                                        ...
                                        <!-- Modal Edit -->
                                        <div class="modal fade" id="EditAdmin<?php echo $data['id_peminjam']; ?>"
                                            tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../f_update/update_adm.php" method="post">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    <label for="id_ruangan">JURUSAN</label>
                                                                        <select class="form-control" id="id_jurusan" name="id_jurusan" value="<?=$data["id_jurusan"]?>" required>
                                                                        <?php
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <select class="form-control" id="role" name="role" value="<?=$data["role"]?>" required>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-6">
                                                                    ...
                                                                    <input type="text" name="no_tlp"
                                                                        class="form-control" id="no_tlp" value="<?= $data['no_tlp'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="submit"
            ...
            <div class="modal fade" id="ModalTambah" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="../f_tambah/simpan_adm.php" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>NIDN / NIK</label>
