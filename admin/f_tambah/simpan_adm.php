...
use PHPMailer\PHPMailer\PHPMailer;
    ...
    $e_password = password_hash($nim, PASSWORD_DEFAULT);
...
$sql = "SELECT * FROM peminjam where nim='$nim'";
    ...
    if(mysqli_num_rows($query) > 0){
        echo "<script>alert('Akun Sudah Terdaftar Sebelumnya. Silahkan Cek Kembali di Data Admin ataupun Data Peminjam');window.location='../view/admin.php';</script>";
    }else {
        ...
        if (!$mail->send()) {
            ...
            echo "<script>alert('Data Berhasil Disimpan , Silahkan melakukan verifikasi Email');window.location='../view/admin.php';</script>";
        }
